        ...
        return array(
            ...
            'tour2' => array(
                ...
                'step5' => array(
                    ...
                    'content' => __('Click on the dropdown, and you will see several options that you can choose from.(Google charts are only available) <br><br>To continue, click on the dropdown.', 'wpdatatables'),
                ),
                'step6' => array(
                    'title' => __('Choose Google chart engine.', 'wpdatatables'),
                    'content' => __('By clicking on Google chart options, you will choose the engine that will render your chart.<br><br> When you finish, please click \'Continue\' button to move forward.', 'wpdatatables'),
                ),
                'step7' => array(
