            ...
            <div class="col-sm-12 wdt-lite-vs-premium-block bg-white p-l-0 p-r-0">
                <div class="card wdt-lite-vs-premium-card m-b-0">
                    ...
                    <div class="card-header wdt-admin-card-header">
                        ...
                        <p><?php _e('Get the most out of wpDataTables by upgrading to Premium and unlocking all of the powerful features.', 'wpdatatables'); ?></p>
                        <a target="_blank"
                           class="btn btn-primary f-500 tms-store-checkout-wpdatatables">
                            <i class="wpdt-icon-star-full m-r-5"></i>
                            <?php _e('Go Premium Now', 'wpdatatables'); ?></a>
                    </div>
                    <div class="wpdt-comparison-div">
                        ...
                        <table id="wpdt-comparison">
                            ...
                            <tr>
                                <td data-title="Features"><?php _e('Export table data <span style="font-size: 8px;">(Export to Excel, CSV, PDF, and Copy and Print options)</span>', 'wpdatatables'); ?>
                                    <hr>
                                </td>
                                <td data-title="Lite" class="text-center bg-grey"><i class="wpdt-icon-check-full"></i>
                                    <hr>
                            ...
                            <tr>
                                <td data-title="Features"><?php _e('Customize charts', 'wpdatatables'); ?>
                                    <hr>
                                </td>
                                <td data-title="Lite"
                                    ...
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="top"
                                       title="<?php _e('Some options are not available.', 'wpdatatables'); ?>"></i>
                                    <hr>
                                </td>
                                <td data-title="Premium" class="text-center bg-blue"><i
                                            class="wpdt-icon-check-full"></i>
                            ...
                            <tr>
                                ...
                                <td data-title="Lite"
                                    class="text-center bg-grey"><?php _e('Limited', 'wpdatatables'); ?>
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="top"
                                       title="<?php _e('Response time is slow and can be up to 5 business days.', 'wpdatatables'); ?>"></i>
                                    <hr>
                                </td>
                                <td data-title="Premium" class="text-center bg-blue"><i
