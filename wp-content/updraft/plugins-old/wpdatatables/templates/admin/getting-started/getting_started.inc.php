                    ...
                    <div class="col-sm-6 card-columns p-r-12 p-l-0">
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span class="d-block"><?php _e('Create a table linked to an existing data source:', 'wpdatatables'); ?><span class="f-400"><?php _e(' create a wpDataTables based on your Excel, CSV file or other data source in a few steps.', 'wpdatatables'); ?></span></span>
                        ...
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <?php if ($tables != 0) { ?>
                                    <div class="wdt-tutorial-desc">
                                        <span class="d-block"><?php _e('Create a chart:', 'wpdatatables'); ?><span class="f-400"><?php _e(' create dynamic charts in WordPress with Google Charts rendering engine.', 'wpdatatables'); ?></span></span>
                        ...
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span class="d-block"><?php _e('Create a table manually:', 'wpdatatables'); ?><span class="f-400"><?php _e(' learn how to build a table completely from the WordPress admin.', 'wpdatatables'); ?></span></span>
                                    <a class="wdt-premium"><?php _e('Available in Premium', 'wpdatatables'); ?></a>
                                    <a class="wdt-compare-link" href="<?php echo admin_url('admin.php?page=wpdatatables-lite-vs-premium'); ?>"><?php _e('Compare and View Pricing', 'wpdatatables'); ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span class="d-block"><?php _e('Create a table by importing data from a data source:', 'wpdatatables'); ?><span class="f-400"><?php _e(' extract data from your existing table to be able to edit it from WordPress.', 'wpdatatables'); ?></span></span>
                                    <a class="wdt-premium"><?php _e('Available in Premium', 'wpdatatables'); ?></a>
                                        <a class="wdt-compare-link" href="<?php echo admin_url('admin.php?page=wpdatatables-lite-vs-premium'); ?>"><?php _e('Compare and View Pricing', 'wpdatatables'); ?></a>
                                </div>
                            </div>
                        ...
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span class="d-block"><?php _e('Generate a query to the MySQL database:', 'wpdatatables'); ?><span class="f-400"><?php _e(' create a table based on your DB data without having to learn SQL', 'wpdatatables'); ?> </span></span>
                                    <a class="wdt-premium"><?php _e('Available in Premium', 'wpdatatables'); ?></a>
                                    <a class="wdt-compare-link" href="<?php echo admin_url('admin.php?page=wpdatatables-lite-vs-premium'); ?>"><?php _e('Compare and View Pricing', 'wpdatatables'); ?></a>
                                </div>
                            </div>
                        ...
                        <div class="card wdt-tutorial-card m-b-18">
                            <div class="card-body wpdt-flex card-padding">
                                ...
                                <div class="wdt-tutorial-desc">
                                    <span class="d-block"><?php _e('Generate a query to the WordPress database:', 'wpdatatables'); ?><span class="f-400"><?php _e(' create a table based on your WP data (posts, meta, taxonomies)', 'wpdatatables'); ?></span></span>
                                    <a class="wdt-premium"><?php _e('Available in Premium', 'wpdatatables'); ?></a>
                                    <a class="wdt-compare-link" href="<?php echo admin_url('admin.php?page=wpdatatables-lite-vs-premium'); ?>"><?php _e('Compare and View Pricing', 'wpdatatables'); ?></a>
                                </div>
                            </div>
