                ...
                <div id="wdt-system-info-tables">
                    ...
                    <table class="wdt-system-info-table" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td class="help"><i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="left"
                                                title="<?php _e('Whether or not you have WordPress Multisite enabled.', 'wpdatatables'); ?>"></i>
                            </td>
                        </tr>
                        <?php
                    ...
                    <table class="wdt-system-info-table m-t-40" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <td class="wpdt-relative">
                                    <span class="wpdt-inline wpdt-error"><?php esc_html_e('Not installed - Please install or enable PHP mbstring Extension on your server.', 'wpdatatables'); ?></span>
                                </td>
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <td class="wpdt-relative">
                                    <span class="wpdt-inline wpdt-error"><?php esc_html_e('Not installed - Please install or enable PHP libxml Extension on your server.', 'wpdatatables'); ?></span>
                                </td>
                            <?php } ?>
                            <td class="help"><i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="left"
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <td class="wpdt-relative">
                                    <span class="wpdt-inline wpdt-error"><?php esc_html_e('Not installed - Please install or enable PHP Zip Extension on your server.', 'wpdatatables'); ?></span>
                                </td>
                            <?php } ?>
                            <td class="help"><i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="left"
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                ...
                                <td class="wpdt-relative">
                                    <span class="wpdt-inline wpdt-error"><?php esc_html_e('Not installed - Please install or enable PHP cURL Extension on your server.', 'wpdatatables'); ?></span>
                                </td>
                            <?php } ?>
                            <td class="help"><i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="left"
