    ...
    function wcz_feedback_notice()
    {
        ...
        if ( current_user_can( 'manage_options' ) && !get_user_meta( $wcz_user_id, 'wcz_feedback_notice_dismiss' ) ) {
            ...
            ?>
				...
				<div class="wcz-notice-columns">
					<div class="wcz-notice-col">
						<h5><?php 
            esc_html_e( 'We\'re still in the early days of release.', 'woocustomizer' );
            ?></h5>
						<div class="wcz-notice-cont">
							<p><?php 
            esc_html_e( 'This means you\'re one of the early users to find and use the StoreCustomizer plugin... If StoreCustomizer doesn\'t work perfectly with your theme right away, I\'ll sure try make it work for you!', 'woocustomizer' );
            ?></p>
						</div>
						<a href="<?php 
            ...
            ?>" class="wcz-notice-btn">
							<?php 
            esc_html_e( 'Go To StoreCustomizer Settings', 'woocustomizer' );
            ?>
						</a>
						<a href="<?php 
            ...
            ?>
					...
					<div class="wcz-notice-col">
						<h5><?php 
            esc_html_e( 'Have you found a bug? Or something not working?', 'woocustomizer' );
            ?></h5>
						<div class="wcz-notice-cont">
							<p><?php 
