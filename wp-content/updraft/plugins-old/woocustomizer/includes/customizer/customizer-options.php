...
function woocustomizer_customizer_library_options()
{
    ...
    if ( WooCustomizer::wcz_is_plugin_active( 'woocommerce.php' ) ) {
        ...
        $options['wcz-add-price-prefix'] = array(
            ...
            'section'     => $section,
            'type'        => 'checkbox',
            'description' => __( 'Edit the prefix per product under Product Data -> StoreCustomizer on each product.<br /><br />To add a suffix to only certain products, simply add nothing here (and save), then edit the suffix setting on each product.', 'woocustomizer' ),
            'default'     => 0,
        );
