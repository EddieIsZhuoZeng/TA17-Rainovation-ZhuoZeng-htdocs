	...
	<fieldset>
		...
		<div>
			<ul>
				...
				{
					?>
					<p class="notice notice-warning" style='float:none; '>
						<?php
						echo sprintf(__('You have no custom fields to filter on. <a href="%s">Add custom fields here</a>.', 'wp-google-maps'),"admin.php?page=wp-google-maps-menu-custom-fields");
						?>
					</p>
					<?php
				}
