...
Text Domain: basic-google-maps-placemarks
...
load_plugin_textdomain( 'basic-google-maps-placemarks', false, basename( dirname( __FILE__ ) ) . '/languages' );

define( 'BGMP_NAME', __( 'Basic Google Maps Placemarks', 'basic-google-maps-placemarks' ) );
