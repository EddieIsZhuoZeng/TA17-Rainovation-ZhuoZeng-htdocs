                        ...
                        <div class="col-sm-6 mysql-settings-block hidden">
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label data-toggle="html-checkbox-premium-popover" data-placement="top" title="" data-content="content" for="wdt-server-side"
                                       class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><?php _e('Enable server-side processing', 'wpdatatables'); ?></label>
                            </div>
                            <!-- /Server side processing toggle -->
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="display-settings">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20 wdt-responsive-block">
                            ...
                            <h4 class="c-title-color m-b-2">
                                <span class="opacity-6" ><?php _e('Responsiveness', 'wpdatatables'); ?></span>
                            ...
                            <div class="hidden" id="table-responsive-hint">
                                <div class="popover-heading">
                                    <span class="opacity-6" ><?php _e('Responsive design', 'wpdatatables'); ?></span>
                                </div>
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-responsive" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                       class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6" ><?php _e('Allow collapsing on mobiles and tablets', 'wpdatatables'); ?></span></label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20">
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-advanced-filter" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                       class="ts-label"> <i class='wpdt-icon-star-full m-r-5' style='color: #FFC078;'></i> <span class="opacity-6" ><?php _e('Enable advanced column filters', 'wpdatatables'); ?></span></label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20 filtering-form-block <?php echo 'hidden' ?>">
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-filter-in-form" data-trigger="focus" data-toggle="html-premium-popover" data-placement="top" title="" data-content="content"
                        ...
                        <div class="col-sm-4 m-b-20 wdt-clear-filters-block <?php echo 'hidden' ?>">
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-clear-filters" data-trigger="focus" data-toggle="html-premium-popover" data-placement="top" title="title" data-content="content"
