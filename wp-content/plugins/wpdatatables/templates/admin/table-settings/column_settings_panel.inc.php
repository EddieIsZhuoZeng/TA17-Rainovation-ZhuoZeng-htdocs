                ...
                <ul class="tab-nav" role="tablist">
                    ...
                    <li class="column-conditional-formatting-settings-tab">
                        <a href="#column-conditional-formatting-settings"
                           ...
                           data-toggle="html-input-premium-popover" data-placement="bottom" title="" data-content="content"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Conditional formatting', 'wpdatatables'); ?></span></a>
                    </li>
                </ul>
                <!-- /ul .tab-nav -->
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="column-display-settings">
                        ...
                        <div class="row wdt-columns-responsive-block">
                            ...
                            <div class="col-sm-6">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Hide on mobiles', 'wpdatatables'); ?></span>
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-hide-column-on-mobiles" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Collapse column on mobile devices', 'wpdatatables'); ?></span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"> <?php _e('Hide on tablets', 'wpdatatables'); ?></span>
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-hide-column-on-tablets" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Collapse column on tablet devices', 'wpdatatables'); ?></span></label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="column-data-settings">
                                    ...
                                    <div class="fg-line">
                                        <div class="select">
                                            <select class="selectpicker" id="wdt-column-values" data-toggle="html-premium-popover" data-placement="top" title="" data-content="content" >
                                                ...
                                                <option value="list" data-content="<i class='wpdt-icon-star-full m-r-5' style='color: #FFC078;'></i><span class='opacity-6' ><?php _e('Define values list', 'wpdatatables'); ?></span>"></option>
                                                <option value="foreignkey" data-content="<i class='wpdt-icon-star-full m-r-5' style='color: #FFC078;'></i><span class='opacity-6' ><?php _e('Use values from another wpDataTable (foreign key)', 'wpdatatables'); ?></span>"></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row wdt-possible-values-options-block">
                            ...
                            <div class="col-sm-6">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Allow empty value', 'wpdatatables'); ?></span>
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-column-values-add-empty" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Add an empty value to the list', 'wpdatatables'); ?></span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6" ><?php _e('Number of possible values to load', 'wpdatatables'); ?></span>
                                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                    ...
                                    <div class="fg-line">
                                        <div class="select">
                                            <select class="selectpicker" id="wdt-possible-values-ajax" data-toggle="html-premium-popover" data-placement="top" title="title" data-content="content" >
                                                ...
                                                <option value="-1" data-content="<i class='wpdt-icon-star-full m-r-5' style='color: #FFC078;'></i> <span class='opacity-6'><?php _e('All', 'wpdatatables'); ?></span>"></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row wdt-numeric-column-block">
                            ...
                            <div class="col-sm-6 wdt-column-calc-total-block">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Calculate total', 'wpdatatables'); ?></span>
                                    <i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-column-calc-total" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Calculate a total for this column', 'wpdatatables'); ?></span></label>
                                    </div>
                            ...
                            <div class="col-sm-6 wdt-column-calc-avg-block">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Calculate average', 'wpdatatables'); ?></span>
                                    <i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-column-calc-avg" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Calculate average for this column', 'wpdatatables'); ?></span></label>
                                    </div>
                            ...
                            <div class="col-sm-6 wdt-column-calc-min-block">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Calculate MIN value', 'wpdatatables'); ?></span>
                                    <i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-column-calc-min" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Find a minimum value for this column', 'wpdatatables'); ?></span></label>
                                    </div>
                            ...
                            <div class="col-sm-6 wdt-column-calc-max-block">
                                <h4 class="c-title-color m-b-2">
                                    <span class="opacity-6"><?php _e('Calculate MAX value', 'wpdatatables'); ?></span>
                                    <i class=" wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                                ...
                                <div class="form-group">
                                    <div class="toggle-switch" data-ts-color="blue">
                                        ...
                                        <label for="wdt-column-calc-max" data-toggle="html-checkbox-premium-popover" data-placement="top" title="title" data-content="content"
                                               class="ts-label"><i class="wpdt-icon-star-full m-r-5" style="color: #FFC078;"></i><span class="opacity-6"><?php _e('Find a maximum value for this column', 'wpdatatables'); ?></span></label>
                                    </div>
