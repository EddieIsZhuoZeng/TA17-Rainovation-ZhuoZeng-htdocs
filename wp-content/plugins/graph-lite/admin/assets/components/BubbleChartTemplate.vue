<template>
	<div class="gl_chart_template" id="bubble">
		<div class="gl_graphOptions">
			...
			<fieldset v-for="(dataset, index) in datasets" :key="dataset">
				...
				<table class="form-table">
									...
									<div class="gl_bb_point">
										<div class="gl_bubble_input_fields">
											...
											<div class="gl_bb_r">
												...
												<input :class="{'gl_fieldRequired': data.ifrPointEmpty}" type="number" id="radius" v-model="dataset.data[PIndex].r" @keyup="addDatasetDataPoints(index, PIndex, 'r')" @mouseup="addDatasetDataPoints(index, PIndex, 'r')">
											</div>
											<p class="gl_fieldRequiredError" v-if="data.ifxPointEmpty || data.ifyPointEmpty || data.ifrPointEmpty">*required</p>
										</div>
										<div v-if="PIndex != 0">
					...
					<tr>
						<th scope="row" style="padding-top: 15px; padding-bottom: 5px;"><label for="colors">Circle Background Color*</label></th>
					...
					<tr>
						<th scope="row" style="padding-top: 15px; padding-bottom: 5px;"><label for="line_color">Circle Border Color*</label></th>
