            ...
            echo '<div class="braapf_attribute_setup_flex">';
                ...
                echo '<div class="braapf_attribute_count_show_hide braapf_half_select_full">';
                    ...
                    echo '<select id="braapf_attribute_count_show_hide" name="'.$settings_name.'[attribute_count_show_hide]">';
                        ...
                        echo '<option value="with_arrow"'.($attribute_count_show_hide == "with_arrow" ? ' selected' : '').'>' . __('Always visible', 'BeRocket_AJAX_domain') . '</option>';
                        echo '<option value="without_arrow"'.($attribute_count_show_hide == "without_arrow" ? ' selected' : '').'>' . __('Always hidden', 'BeRocket_AJAX_domain') . '</option>';
                    echo '</select>';
                echo '</div>';
            echo '</div>';
        }
