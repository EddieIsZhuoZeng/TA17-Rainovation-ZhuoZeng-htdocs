	...
	private function wcz_menu_settings() {
		return apply_filters(
			...
			array(
				...
				'menu_title'  => __( 'StoreCustomizer', 'woocustomizer' ),
	...
	private function settings_fields() {
		...
		if ( ! wcz_fs()->can_use_premium_code() ) {
			...
			$settings['wcz_general'] = array(
				'title'       => __( 'General Settings', 'woocustomizer' ),
	...
	public function settings_page() {
		...
		if ( is_array( $this->settings ) && 1 < count( $this->settings ) ) {
			...
			foreach ( $this->settings as $section => $data ) {
				...
				$tabisnew = '';
				// if ( 'handh' == strtolower( $tabnew ) ) // ADJUST FOR NEW TABS
				//  	$tabisnew = '<span class="isnew">NEW</span>';
