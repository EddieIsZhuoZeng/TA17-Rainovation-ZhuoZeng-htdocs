 ...
 * Description: Customize WooCommerce without code... StoreCustomizer has all the WooCommerce hooks & lots more features built into one plugin, to further edit your WooCommerce Shop and Product pages, Cart, Checkout and User Account pages.
 * Author: Kaira
 ...
 * @since 1.0.0
 */
define( 'WCD_PLUGIN_VERSION', '2.2.0' );
