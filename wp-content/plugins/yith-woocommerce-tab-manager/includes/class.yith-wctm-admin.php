...
if ( ! class_exists( 'YITH_WCTM_Admin' ) ) {
	...
	class YITH_WCTM_Admin {
		...
		public function enqueue_admin_style() {
			...
			$is_panel_page = isset( $_GET['page'] ) &&  'yith_wc_tab_manager_panel' == $_GET['page'];

			if ( ($is_panel_page) || ( isset( $current_screen->post_type ) && ( in_array( $current_screen->post_type , array(  'ywtm_tab' , 'product') )  ) ) ) {
